 ...
 */
	Configure::write('Security.salt', 'skz-_5NzNaNm1m_vD-4Mf7nP4C--_mO_3nEb1cdmm_4---RH1a');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '9785162437559487897856759875541678975');
